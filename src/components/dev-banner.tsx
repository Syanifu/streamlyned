    ...
    <div className="fixed bottom-4 right-4 z-50 font-sans">
      ...
      {!isOpen && (
        ...
        >
          ...
          {currentRole ? (
            <span className="bg-indigo-900 text-indigo-200 px-1.5 py-0.5 rounded text-[10px] font-mono">
              {currentRole}
            </span>
          ) : (
          ...
          <div className="bg-neutral-50 border border-neutral-100 rounded p-2 mb-3 text-xs font-mono">
            ...
            <div className="flex justify-between mt-1">
              ...
              <span className="text-neutral-700">
                {currentRole ? (
                  <span className="bg-indigo-100 text-indigo-800 px-1 rounded font-sans font-semibold text-[10px]">
                    {currentRole}
                  </span>
                ) : (
                  "guest"
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    <Users size={12} className={isActive ? "text-indigo-600" : "text-neutral-400"} />
            ...
            <div className="space-y-2">
              <div>
                <input
                  ...
                  className="w-full text-xs px-2.5 py-1.5 border border-neutral-200 rounded focus:outline-none focus:border-indigo-500"
                />
              </div>
              <div className="flex gap-2">
                <input
                  ...
                  className="w-1/2 text-xs px-2.5 py-1.5 border border-neutral-200 rounded focus:outline-none focus:border-indigo-500"
                />
                <button
